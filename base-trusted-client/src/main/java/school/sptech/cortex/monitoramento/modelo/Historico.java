...
public class Historico {
    ...
    public Historico(Boolean cpu, Boolean ram, Boolean gpu, Boolean disco, Double valorCpu, Double valorGpu, Double valorDisco, Double valorRam, LocalDateTime timestamp, Boolean downtimeServer, Boolean downtimeProcesso, Double cpu_processo, Double ram_processo, Double gpu_processo) {
        this.cpu = cpu;
        this.ram = ram;
        this.gpu = gpu;
        this.disco = disco;
